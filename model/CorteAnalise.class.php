...
class CorteAnalise {
    ...
    public $idcorteAnalise;

    const tabela = 'corteAnalise';

    public function __construct($idcorteAnalise = NULL) {
        $this->idcorteAnalise = $idcorteAnalise;
    }
